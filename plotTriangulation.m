...
ptch = patch('vertices', mesh.vert, 'faces', mesh.faces, ...
    'facecolor',[140, 201, 227]./255, 'facealpha',0.65, ...
    'edgecolor', 0.3*[1 1 1], 'edgealpha', 0.9);
...
text(txtmesh(:,1), txtmesh(:,2), txtmesh(:,3)+max(abs(mesh.vert(:)))*0.02*sign(txtmesh(:,3)), temps, 'FontSize', 12, 'FontWeight', 'bold');
